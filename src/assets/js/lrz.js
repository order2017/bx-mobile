        ...
        create: function (file, callback) {
            ...
            img.onload = function () {
                ...
                EXIF.getData(img, function () {
                    ...
                    //新添加
                    // console.log((results.origin.type.split('/'))[1]);

                    ctx.drawImage(img,0, 0, resize.w, resize.h);
                    console.log('4、'+myData.getTime());
                    ...
                    try {
                        results.base64 = canvas.toDataURL('image/png');
                    } catch (_error) {
                        alert('未引用mobile补丁，无法生成图片。');
                    }
                    // results.base64 = canvas.toDataURL('image/png', that.defaults.quality);
                    // results.base64 = canvas.toDataURL('image/'+(results.origin.type.split('/'))[1], that.defaults.quality);
                    console.log('5、'+myData.getTime());
